    ...
    <div className="container-p mx-auto max-w-md mt-16">
      <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Login to save properties and manage listings
        </p>
        ...
        <button className="w-full rounded-md border border-border py-2.5 text-sm font-semibold hover:bg-secondary">
          Continue with Google
        </button>
        <button className="w-full mt-2 rounded-md border border-border py-2.5 text-sm font-semibold hover:bg-secondary">
          Login with OTP
        </button>
