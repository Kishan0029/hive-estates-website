...
export const Route = createFileRoute("/post-property")({
  head: () => ({
    meta: [
      { title: "List Your Property — Hive Estate" },
      { name: "description", content: "List your property on Hive Estate. Reach genuine buyers in Belagavi." },
    ],
  }),
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="max-w-xl">
                    <h1 className="font-display text-4xl font-extrabold text-foreground tracking-tight sm:text-5xl">
                      Sell or rent your property to genuine buyers
                    </h1>
                    <p className="text-muted-foreground mt-4 mb-8">Hive Estate guarantees verified buyers. Keep these ready to ensure a smooth listing process.</p>
                  </div>
