  ...
  return (
    <div className="container-p mx-auto max-w-7xl mt-8">
      ...
      <p className="text-sm text-muted-foreground mt-1">
        Trusted developers with completed and ongoing projects
      </p>
      <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {BUILDERS_LIST.map((b) => (
          <article
            key={b.id}
            className="rounded-xl border border-border bg-card overflow-hidden shadow-card hover:shadow-elevated transition"
          >
            ...
            <div className="p-5">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                <div className="rounded-md bg-secondary p-2">
                  ...
                  <div className="font-semibold text-sm">{b.projects}</div>
                </div>
                <div className="rounded-md bg-secondary p-2">
                  <span className="text-muted-foreground">Completed</span>
                  <div className="font-semibold text-sm">{b.completed}</div>
                </div>
              </div>
              <button className="mt-4 w-full rounded-md bg-primary py-2 text-sm font-semibold text-primary-foreground">
                View Projects
              </button>
            </div>
          </article>
